...
namespace ML_DigramsDatabase
{
    ...
    {
        /// <summary>
        /// model input class for MLModel_DigramDb.
        /// </summary>
        ...
        public class ModelInput
        {
            ...
            [LoadColumn(1)]
            [ColumnName(@"isInstrumental")]
            public float IsInstrumental { get; set; }
        ...
        /// <summary>
        /// model output class for MLModel_DigramDb.
        /// </summary>
        #region model output class
        public class ModelOutput
        {
            [ColumnName(@"word")]
            public float[] Word { get; set; } = default!;

            [ColumnName(@"isInstrumental")]
            public uint IsInstrumental { get; set; }
        ...
        private static readonly string _mLNetModelPath = Path.GetFullPath("MLModel_DigramDb.mlnet");
        ...
        private static IEnumerable<string> GetLabels()
        {
            ...
            var labelColumn = schema.GetColumnOrNull("isInstrumental") ?? throw new Exception("isInstrumental column not found. Make sure the name searched for matches the name in the schema.");

            // Key values contains an ordered array of the possible labels. This allows us to map the results to the correct label value.
            var keyNames = new VBuffer<float>();
            labelColumn.GetKeyValues(ref keyNames);
